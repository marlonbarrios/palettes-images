...
function preload() {
  loadImage('data/pic1.jpeg', setImage);
}
...
function keyReleased() {
  ...
  if (key == '1') loadImage('data/pic1.jpeg', setImage);
  if (key == '2') loadImage('data/pic2.jpeg', setImage);
  if (key == '3') loadImage('data/pic3.jpeg', setImage);
  if (key == '4') loadImage('data/pic4.jpeg', setImage);
